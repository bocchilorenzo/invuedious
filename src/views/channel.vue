  ...
  methods: {
    ...
    async getChannelData() {
      ...
      await fetch(url, {
        ...
        .then((response) => {
          document.title = response.author + " - Invuedious";
          let tmpObj = {};
          tmpObj = response;
          tmpObj.formattedSubs = numeral(response.subCount).format("0a");
          if (
          ...
          tmpObj.dateJoined = this.timeConverter(response.joined);
          tmpObj.formattedViews = response.totalViews + " views";
